...
void MeasureSpeed_one_init(void)
{
  ...
  TPM_PWM_init(TPM0 , CH0, 8000,0);       //电机占空比设置初始化    占空比 = duty /(MOD +1 ) ;FTM_CnV_REG(FTMx[ftmn], ch) = cv;
  TPM_PWM_init(TPM0 , CH0, 8000,0);  
...
{    
  TPM_PWM_init(TPM0 , CH0, 8000,0);       //电机占空比设置初始化    占空比 = duty /(MOD +1 ) ;FTM_CnV_REG(FTMx[ftmn], ch) = cv;
  TPM_PWM_init(TPM0 , CH1, 8000,0);  
  TPM_PWM_init(TPM0 , CH2, 8000,0);       //电机占空比设置初始化    占空比 = duty /(MOD +1 ) ;FTM_CnV_REG(FTMx[ftmn], ch) = cv;
  TPM_PWM_init(TPM0 , CH3, 8000,0);
