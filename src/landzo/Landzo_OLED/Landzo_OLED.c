...
#define OLED_SCL  PTB1_OUT  // D0
#define OLED_SDA  PTB0_OUT  // D1
#define OLED_RST  PTB3_OUT  // RST
#define OLED_DC   PTB2_OUT  // DS
#define OLED_CS   PTB4_OUT  // CS
...
void OLED_Init(void)
{
  gpio_init (PTB0, GPO,HIGH);
  gpio_init (PTB1, GPO,HIGH);
  gpio_init (PTB2, GPO,HIGH);
  gpio_init (PTB4, GPO,HIGH);
  gpio_init (PTB3, GPO,LOW);
