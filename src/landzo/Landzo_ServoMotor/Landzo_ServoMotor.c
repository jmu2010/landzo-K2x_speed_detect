...
{
   TPM_PWM_init(TPM1, CH0 , 50,23);                           //舵机占空比设置初始化   MOD =19531 ;
   TPM_PWM_init(TPM1, CH1 , 50,23);                           //舵机占空比设置初始化   MOD =19531 ; 
...
{
   TPM_PWM_init(TPM1, CH1 , 180,23);                           //舵机占空比设置初始化   MOD =19531 ;
   TPM_PWM_init(TPM1, CH0 , 180,23);                           //舵机占空比设置初始化   MOD =19531 ; 
}
