...
void Key_Init(void)
{   
    gpio_Interrupt_init(PTA5, GPI_DOWN,  RING);
    gpio_Interrupt_init(PTA14, GPI_DOWN,  RING);
    gpio_Interrupt_init(PTA15, GPI_DOWN,  RING);
    gpio_Interrupt_init(PTA16, GPI_DOWN,  RING);
    gpio_Interrupt_init(PTA17, GPI_DOWN,  RING);   
}
/*********************************************************** 
函数名称：Key_print 
函数功能：显示角度和加速度初始化
